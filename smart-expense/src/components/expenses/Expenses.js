...
const Expenses = () => {
  ...
  const handleFormChange = (e) => {
    ...
    if (name === 'category') {
      const selectedCategory = state.expenseCategories.find(cat => cat.name === value);
      setFormData(prev => ({
        ...prev,
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <span className="text-lg mr-2">
                        {state.expenseCategories.find(cat => cat.id === expense.categoryId)?.icon}
                      </span>
          ...
          {filteredExpenses.length === 0 && (
            <div className="text-center py-12">
              <div className="text-gray-500">
                <p className="text-lg">No expense entries found</p>
